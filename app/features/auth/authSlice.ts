...
const authSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(login.rejected, (state, action) => { state.loading = false; state.error = action.error.message || 'Erro no login' })
      .addCase(fetchUser.fulfilled, (state, action) => { state.user = action.payload || null })
